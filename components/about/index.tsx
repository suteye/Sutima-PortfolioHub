...
export default function Index() {
  ...
  return (
    ...
    <main className=" container">
      <div
        ref={description}
        className="grid auto-cols-[1fr]  grid-cols-[1fr] grid-rows-[auto] gap-x-12 gap-y-8 md:grid-cols-[1fr_1fr]"
      >
        <div className="col-span-1 row-span-1 text-[clamp(1.6rem,1.434rem+0.707vw,2rem)]">
          I'm Sutima Phetsatien, a Front-end developer and Web developer with a
          passion for creating visually striking and user-friendly websites.
        </div>
        <div className="flex flex-col items-start">
          <div className="mt-[clamp(0rem,-2.901rem+12.376vw,7rem)]">
            As a Web developer, I have a passion for creating innovative and
            user-friendly websites. With a strong background in programming and
            design, I thrive on turning ideas into functional and visually
            appealing online experiences. My goal is to stay up-to-date with the
            latest web technologies and deliver solutions that meet both client
